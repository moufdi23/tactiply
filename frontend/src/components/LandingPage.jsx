    ...
    <div className="min-h-screen overflow-x-hidden" style={{ background: '#f8fafc' }}>
      ...
      <footer style={{ background: '#0f172a' }}>
        ...
        <div className="max-w-6xl mx-auto px-6 pt-10 pb-6">
          {/* Brand + socials */}
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-8 pb-8 mb-8"
            ...
            <div>
              ...
              <p className="text-base sm:text-sm leading-relaxed" style={{ color: '#94a3b8', maxWidth: 260 }}>
                AI-powered marketing strategies for small businesses. Free. Instant. No fluff.
              </p>
            </div>
            <div className="flex items-center gap-2.5">
              <a href="https://github.com/moufdi23" aria-label="GitHub" target="_blank" rel="noopener noreferrer" className="footer-social">
              ...
              <a href="https://www.linkedin.com/in/moufdi-ben-saadoune/" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer" className="footer-social">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="white" aria-hidden="true">
          ...
          {/* Built With */}
          <div className="mb-6">
            <p className="text-xs font-bold tracking-widest uppercase mb-3" style={{ color: '#94a3b8' }}>Built With</p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-6"
            ...
            <p className="text-xs" style={{ color: '#94a3b8' }}>© 2026 Tactiply. All rights reserved.</p>
