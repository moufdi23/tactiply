...
const BMAC_URL          = 'https://buymeacoffee.com/tactiply';
...
async function exportToPDF(sections, businessDescription) {
  ...
  doc.setFontSize(9);
  doc.setTextColor(...S5);
  doc.text('Generated by Tactiply — AI-powered marketing for every business.', M, afterBiz + 34);
  doc.text('tactiply.com', M, afterBiz + 41);
  ...
  doc.save(`Tactiply-Strategy-${pdfSlugify(businessDescription)}-${pdfDateSlug()}.pdf`);
}
  ...
  return (
    <div className="flex flex-col overflow-hidden" style={{ height: '100vh', background: '#f8fafc' }}>
      ...
      <header className="flex-shrink-0 flex items-center justify-between px-5 py-3"
        ...
        <button onClick={onReset} className="flex items-center gap-2.5 cursor-pointer group" style={{ background: 'none', border: 'none', padding: 0 }}>
          <div className="w-7 h-7 rounded-lg flex items-center justify-center text-white flex-shrink-0 transition-transform duration-200 group-hover:scale-105"
            style={{ background: 'linear-gradient(135deg,#059669,#047857)' }}>
            <Zap className="w-3.5 h-3.5" />
          </div>
          <span className="font-black text-sm text-slate-900 transition-colors duration-200 group-hover:text-emerald-700">Tactiply</span>
        </button>
        ...
        <div className="flex items-center gap-2.5">
          ...
          {isSample ? (
            <button onClick={onReset}
              ...
              style={{ background: 'linear-gradient(135deg,#059669,#047857)', color: '#ffffff', boxShadow: '0 2px 8px rgba(5,150,105,0.28)' }}>
        ...
        <main className="flex-1 overflow-y-auto flex flex-col" style={{ background: '#f8fafc' }}>
          ...
          <div className="flex-shrink-0 px-6 py-4" style={{ background: '#ffffff', borderTop: '1px solid #e2e8f0' }}>
            <div className="max-w-3xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2">
              <p className="text-slate-400 text-xs">© 2026 Tactiply · Powered by Claude AI</p>
